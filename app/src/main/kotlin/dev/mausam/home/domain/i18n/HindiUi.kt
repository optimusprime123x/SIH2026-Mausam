...
object HindiUi {
    val table: Map<String, String> = mapOf(
        ...
        "School run" to "स्कूल आना-जाना",
        "The school-commute card and the parents' brief use this window" to "स्कूल आने-जाने का कार्ड और अभिभावकों की ब्रीफ़ इसी समय पर आधारित हैं",
        "School run starts" to "स्कूल जाना शुरू",
        "School run ends" to "स्कूल जाना समाप्त",
